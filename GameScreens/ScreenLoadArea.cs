...
namespace Gahame.GameScreens
{
    public class ScreenLoadArea
    {
        ...
        // Constructor (lmao don't know if I need this)
        public ScreenLoadArea()
        {
        ...
        public void CheckCollisionWithPlayer(Vector2 playerPosition)
        {
                ...
                Position.Y + Size.Y > playerPosition.Y)
            {
                ...
                {
                    ScreenManager.Instance.LoadNextScreen(ScreenName);
                }
                else if (ScreenManager.Instance.nextScreen.Name != ScreenName)
                {
                    ScreenManager.Instance.LoadNextScreen(ScreenName);
                }
            }
